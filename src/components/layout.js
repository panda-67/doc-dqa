		...
		<>
			<div className="h-full md:grid grid-cols-12 bg-white dark:bg-stone-800 dark:text-white duration-300 ease-in">
				...
				<div className="mt-6 mr-6 absolute right-3 z-20 md:hidden block">
					<button onClick={themeToggle} data-toggle-theme="dark,light" data-act-class="ACTIVECLASS" className="absolute right-10">
						{themeDark === true
							...
							: <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-6 h-6"><path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" className="stroke-current"></path><path d="M12 4v1M17.66 6.344l-.828.828M20.005 12.004h-1M17.66 17.664l-.828-.828M12 20.01V19M6.34 17.664l.835-.836M3.995 12.004h1.01M6 6l.835.836" className="stroke-current"></path></svg>
						}
					</button>
