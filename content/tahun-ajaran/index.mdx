...
Terdapat beberapa kolom pada halaman tahun ajaran ini, kolom tersebut sebagai berikut:<br/>

1. Kolom tahun menunjukkan tahun dari tahun ajaran; <br/>
2. Kolom status pendaftaran menunjukkan status keaftifan dari halaman formulir pendaftaran; <br/>
3. Kolom info pendaftaran (<i>home</i>) menunjukkan status keaftifan dari info pendaftaran yang terdapat pada halaman utama website DQA; <br/>
4. Kolom info pendaftaran (panduan) menunjukkan status keaftifan dari info pendaftaran yang terdapat pada halaman panduan pendaftaran; <br/>
5. Kolom file brosur, kolom file panduan, dan kolom file pernyataan menunjukkan dua hal yaitu, ada atau tidak adanya file tertentu dan akfif atau tidak aktifnya tombol download dari file tersebut; <br/>
6. Kolom keaftifan menunjukkan status keaftifan dari tahun ajaran tertentu. Tahun Ajaran hanya dapat diaktifkan salah satu, bila ingin mengaktifkan Tahun Ajaran yang lain dari yang sedang aktif, maka Tahun Ajaran yang sedang aktif harus dinonaktifkan terlebih dahulu. 

<br/>

<b><i>Hal-hal yang perlu diperhatikan!</i></b><br/>

Ketika menentukan aktif atau tidak aktifnya suatu hal, seperti ketika mengaktifkan file panduan, setelah mengktifkan file panduan, tombol untuk mendownload file panduan tidak serta merta akftif melainkan harus mengaktifkan info pendaftaran pada halaman panduan. Hal yang sama juga berlaku pada tombol download file pernyataan, meskipun sudah menampilkan file pernyataan pada pengaturan namun belum mengaktifkan status pendaftaran maka file tersebut juga belum bisa di download.
